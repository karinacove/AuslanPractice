...
const classData = {
  ...
  "34F": ["Aisling G","Alarah P","Aria H","Aria T","Bella S","Darcy P","Eason W","Eloise B","Ezra T","Jayce M","Kaylee W","Levi V","Lily R","Mason M","Matilda C","Noah R","Oliver C","Rachel J","River O","Sam M","Quinn L"],
  ...
  "56K": ["Aiden N","Alira B","Amelia T","Bowie H","Declan C","Elliott M","Emilia S","Hurricane B","Jade M","James H","Jayce M","Kelina H","Khaleesi B","Lachlan W","Marlie H","Mason M","Max H","Mishal K","Oliver W","Ryan J","Ryder V","Summer W","Will L","Zach M"],
